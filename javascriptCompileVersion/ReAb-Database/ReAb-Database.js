...
(function (deps, factory) {
    ...
    var ReAbDatabase; // Metodo que convierte toda la base de datos ReAb en objetos de javascript y coloca dicha base de datos en un array llamada ReAbCollection
